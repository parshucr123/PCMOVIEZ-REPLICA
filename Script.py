class script(object):
    START_TXT = """<b>HELLO DEAR❤️ {} 
    
ɪ ᴀᴍ ᴘᴏᴡᴇʀғᴜʟ PC MOVIEZ ᴀᴜᴛᴏ ғɪʟᴛᴇʀ ʙᴏᴛ💪
I Cᴀɴ Pʀᴏᴠɪᴅᴇ Mᴏᴠɪᴇs IN GROUPS, \n\nJᴜsᴛ Aᴅᴅ Mᴇ Tᴏ Yᴏᴜʀ Gʀᴏᴜᴘ AS AN ADMIN🤩 \n\n& TYPE ANY MOVIE NAME YOU WANT TO WATCH 😍\n\nI'LL PROVIDE IT IN A FLASH,YOU JUST ENJOY WATCHING IT💕

ᴄʀᴇᴀᴛᴏʀ : <a href="https://t.me/parshucr">Pᴀʀsʜᴜʀᴀᴍ</a> 😎
ᴍᴀɴᴛᴀɪɴᴇᴅ ʙʏ: <a href="https://t.me/parshucr">MOVIE KING</a>👑 </b>"""
...
ᴘʟᴇᴀꜱᴇ ꜱᴇɴᴅ ᴛʜᴇ ʀᴇQᴜᴇꜱᴛ ᴀɢᴀɪɴ."""
    ...
    CUDNT_FND = """😣SORRY NO FILES FOUND FOR {}
PLZ SELECT FROM THE BELOW👇 RESULTS
OR REQUEST TO ADMIN @parshucr"""
...
ᴘʟᴇᴀꜱᴇ ᴄʜᴇᴄᴋ ᴛʜᴇ ꜱᴘᴇʟʟɪɴɢ ᴏɴ ɢᴏᴏɢʟᴇ ᴏʀ ɪᴍᴅʙ..."""
    ...
    MVE_NT_FND = """ᴍᴏᴠɪᴇ ɴᴏᴛ ꜰᴏᴜɴᴅ ɪɴ ᴅᴀᴛᴀʙᴀꜱᴇ, REQUEST TO ADMIN @parshucr..."""
